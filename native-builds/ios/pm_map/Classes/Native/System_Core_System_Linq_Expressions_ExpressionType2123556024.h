...
struct  ExpressionType_t2123556024 
{
public:
...
public:
	inline static int32_t get_offset_of_value___1() { return static_cast<int32_t>(offsetof(ExpressionType_t2123556024, ___value___1)); }
