...
struct  XPathNodeIterator_t1383168931  : public Il2CppObject
{
public:
...
public:
	inline static int32_t get_offset_of__count_0() { return static_cast<int32_t>(offsetof(XPathNodeIterator_t1383168931, ____count_0)); }
