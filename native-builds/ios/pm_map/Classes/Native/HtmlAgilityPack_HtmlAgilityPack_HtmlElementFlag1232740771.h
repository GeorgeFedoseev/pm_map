...
struct  HtmlElementFlag_t1232740771 
{
public:
...
public:
	inline static int32_t get_offset_of_value___1() { return static_cast<int32_t>(offsetof(HtmlElementFlag_t1232740771, ___value___1)); }
