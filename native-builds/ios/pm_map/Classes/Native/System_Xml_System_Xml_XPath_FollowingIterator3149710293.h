...
struct  FollowingIterator_t3149710293  : public SimpleIterator_t544647972
{
public:
...
public:
	inline static int32_t get_offset_of__finished_6() { return static_cast<int32_t>(offsetof(FollowingIterator_t3149710293, ____finished_6)); }
