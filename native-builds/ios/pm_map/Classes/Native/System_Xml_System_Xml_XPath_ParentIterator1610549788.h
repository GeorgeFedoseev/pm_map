...
struct  ParentIterator_t1610549788  : public SimpleIterator_t544647972
{
public:
...
public:
	inline static int32_t get_offset_of_canMove_6() { return static_cast<int32_t>(offsetof(ParentIterator_t1610549788, ___canMove_6)); }
