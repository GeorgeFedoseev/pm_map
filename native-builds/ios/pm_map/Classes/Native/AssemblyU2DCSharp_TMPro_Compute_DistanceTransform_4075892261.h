...
struct  Compute_DistanceTransform_EventTypes_t4075892261 
{
public:
...
public:
	inline static int32_t get_offset_of_value___1() { return static_cast<int32_t>(offsetof(Compute_DistanceTransform_EventTypes_t4075892261, ___value___1)); }
