...
struct  XPathResultType_t516720010 
{
public:
...
public:
	inline static int32_t get_offset_of_value___1() { return static_cast<int32_t>(offsetof(XPathResultType_t516720010, ___value___1)); }
