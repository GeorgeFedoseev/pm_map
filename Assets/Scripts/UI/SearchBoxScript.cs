...
public class SearchBoxScript : MonoBehaviour {
	...
	List<string> placeholderValues = new List<string>() {
		"210Д", "столовая", "кофе", "228", "345", "239", "422", "вода", "туалет", "учебный отдел", "бухгалтерия",
		"йогурт", "кексы", "128Д", "библиотека", "101Е", "читальный зал", /*"wi-fi",*/
		"выход", "банка", "банкомат", "гардероб", "Екимов", "Петросян", "Добрынин", "Еремин",
		"Едаменко", "вахта", "мел", "Андрианов", "Виноградова", "Гришкин", "Давыденко", "Зубов", "Егоров",
		"Никитин", "Полякова", "Расова", "объявления"
	};
